...
class WordCategory
{
    ...
    /**
     * @var Word $word
     * @ManyToOne(targetEntity="App\DataSourceLayer\Infrastructure\LearningMetadata\Doctrine\Entity\Word\Word")
     */
    private $word;
    /**
     * @var Category
     * @ManyToOne(targetEntity="App\DataSourceLayer\Infrastructure\LearningMetadata\Doctrine\Entity\Category")
     */
    private $category;
    /**
